    ...
    <div className="min-h-screen bg-[#0F1117] text-white">
      ...
      <section className="pt-32 pb-24 relative overflow-hidden">
        ...
        <div className="container relative z-10 max-w-3xl">
          <div className="mb-6 inline-block px-3 py-1 rounded-full bg-blue-600/15 border border-blue-500/30">
            <span className="text-xs font-semibold text-blue-300" style={{ fontFamily: "Inter, sans-serif" }}>
              Digital Wallet & Loyalty Platform
            </span>
          </div>

          <h1 className="text-6xl md:text-7xl font-extrabold text-white mb-6 leading-tight" style={{ fontFamily: "Syne, sans-serif" }}>
            One card.<br />
            <span className="text-blue-400">Every customer.</span><br />
            Every visit.
          </h1>

          <p className="text-lg text-slate-400 mb-8 leading-relaxed" style={{ fontFamily: "Inter, sans-serif" }}>
          ...
          <div className="flex flex-wrap gap-4">
            <button className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-3.5 rounded-lg font-semibold flex items-center gap-2 transition-colors">
              Book a Demo
              <ArrowRight size={16} />
            </button>
          ...
          {/* Trust badges */}
          <div className="mt-12 flex flex-wrap gap-6 text-sm text-slate-400" style={{ fontFamily: "Inter, sans-serif" }}>
            <div className="flex items-center gap-2">
      ...
      <section className="py-20 bg-[#0A0D14] border-t border-white/6">
        <div className="container">
          <h2 className="text-3xl font-bold text-white mb-12 text-center" style={{ fontFamily: "Syne, sans-serif" }}>
            What you get
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div
                key={feature.title}
                className="rounded-xl p-6 border border-white/8 bg-white/3 hover:border-white/15 hover:bg-white/5 transition-all"
              >
      ...
      <section className="py-20 bg-[#0F1117]">
        <div className="container text-center">
          ...
          <button className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-3.5 rounded-lg font-semibold flex items-center gap-2 mx-auto transition-colors">
            Book a Demo
            <ArrowRight size={16} />
          </button>
        </div>
      ...
      {/* Footer */}
      <footer className="border-t border-white/6 bg-[#0A0D14] py-12">
        <div className="container">
          ...
          <div className="border-t border-white/6 pt-8 flex flex-col md:flex-row items-center justify-between">
